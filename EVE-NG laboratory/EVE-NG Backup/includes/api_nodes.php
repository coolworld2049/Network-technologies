...
function apiGetLabNodeTemplate($p) {
	...
	if ($p['type'] == "qemu") {
                        ...
                        $output['data']['options']['qemu_version'] =  Array(
                                ...
                                'list'  => Array ( '1.3.1' => '1.3.1' ,'2.0.2' => '2.0.2','2.2.0' => '2.2.0','2.4.0' => '2.4.0','2.5.0' => '2.5.0','2.6.2' => '2.6.2', '2.12.0' => '2.12.0', '3.1.0' => '3.1.0', '4.1.0' => '4.1.0', '' => 'tpl'.( isset($p['qemu_version'])?'('.$p['qemu_version'].')':"(default 2.4.0)")));
